...
("MxDrawToolBarFile" "MxDraw.dll" (214 211 206) "top" "浏览" "Y")

// 文件中的工具命令字符串每项说明.
// ("命令名称" "命令提示字符串" "命令" "图标索引字符串")
("打开dwg文件" "打开dwg文件" "OpenDwg" "IDB_OPENDWG_BITMAP")
("打开网上dwg文件" "打开网上dwg文件" "_OpenWebDwg" "IDB_OPENWEBDWG_BITMAP")
("SEPARATOR")
...
("视区旋转45度" "视区旋转45度命令" "DViewTW45" "IDB_DVIEWTW45_BITMAP")
